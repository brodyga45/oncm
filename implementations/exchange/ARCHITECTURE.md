...
| Social | Original ECP, immutable ExchangeSocialHook, Solady SSTORE2 | Full profiles/blogs/comments/replies/votes/history in chain state; locked channel, direct wallet authorship. See ONCHAIN-SOCIAL.md. |
| Offchain             | Express JSON store, SIWE, React, ethers SDK                                                    | Read/rebuild chain views, import public pinned research, private source jobs. No social authorship or payout authority.                                                                                                         |
