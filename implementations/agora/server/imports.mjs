...
export function fixtures(root){const f=path.join(root,'proof/fixtures.json');if(!fs.existsSync(f))return[];const data=JSON.parse(fs.readFileSync(f,'utf8'));return Array.isArray(data)?data:data.fixtures??[];}
