// Independent common validator copy; only codec adapter differs (viem + scure).
...
import {encodeAbiParameters,sha256,stringToBytes as toUtf8Bytes} from 'viem';
import {base64} from '@scure/base';
const decodeBase64=base64.decode,encodeBase64=base64.encode;
const abi={encode:(types,values)=>encodeAbiParameters(types.map(type=>({type})),values)};
